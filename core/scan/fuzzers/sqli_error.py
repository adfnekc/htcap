...
responses = {
    "mysql": [
        r'SQL syntax.*?MySQL', r'Warning.*?mysql_', r'MySqlException \(0x',
        r'MySQLSyntaxErrorException', r'valid MySQL result',
        r'check the manual that corresponds to your (MySQL|MariaDB) server version',
        r'Unknown column \'[^ ]+\' in \'field list\'', r'MySqlClient\.',
        r'com\.mysql\.jdbc\.exceptions', r'Zend_Db_Statement_Mysqli_Exception',
    ...
    def fuzz(self):
        ...
        for m in mutations:
            ...
            if self.check_response(resp.body):
                ...
                self.vulnerabilities.append("%s=%s  %s" %
                                            (m.parameter, m.payload, m.body))
